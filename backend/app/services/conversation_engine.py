...
class ConversationEngine:
    ...
    def generate_reply(self, *, lead: Lead, call: CallRecord, user_text: str) -> dict:
        detected_language = self.detect_language(user_text, call.detected_language or lead.preferred_language)
        knowledge_docs = self.knowledge_base.retrieve(user_text)
        memory_docs = self.memory_service.retrieve_memories(lead_id=lead.lead_id, query=user_text)
